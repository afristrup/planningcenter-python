    ...
    async with httpx.AsyncClient() as client:
        ...
        if response.status_code == 200:
            ...
            for registration in data['data']:
                ...
                print(f"     ✅ Registered: {registration['attributes']['registered_count']}")
        ...
        if response.status_code == 200:
            ...
            for attendee in data['data']:
                print(f"  👤 {attendee['attributes']['first_name']} {attendee['attributes']['last_name']}")
        ...
        if response.status_code == 200:
            data = response.json()
            print(f"Page 1: {len(data['data'])} people (offset: {data['meta']['offset']})")
